...
main(void)
{
	...
	NEG_CHECK(v1, &v1, &v2, NULL);
	NEG_CHECK(v1, &v2, &v1, NULL);
	NEG_CHECK(v2, &v2, &v3, NULL);
	NEG_CHECK(v2, &v3, &v2, NULL);
	NEG_CHECK(v3, &v3, &v4, NULL);
	NEG_CHECK(v3, &v4, &v3, NULL);
	NEG_CHECK(v4, &v4, &v5, NULL);
	NEG_CHECK(v4, &v5, &v4, NULL);
	NEG_CHECK(v5, &v5, &v6, NULL);
	NEG_CHECK(v5, &v6, &v5, NULL);
	NEG_CHECK(v6, &v6, &v7, NULL);
	NEG_CHECK(v6, &v7, &v6, NULL);
	NEG_CHECK(v7, &v7, &v8, NULL);
	NEG_CHECK(v7, &v8, &v7, NULL);
	NEG_CHECK(v8, &v8, &v9, NULL);
	NEG_CHECK(v8, &v9, &v8, NULL);
	NEG_CHECK(v9, &v9, &v10, NULL);
	NEG_CHECK(v9, &v10, &v9, NULL);
	NEG_CHECK(v10, &v10, &v11, NULL);
	NEG_CHECK(v10, &v11, &v10, NULL);
	NEG_CHECK(v11, &v11, &v12, NULL);
	NEG_CHECK(v11, &v12, &v11, NULL);
	NEG_CHECK(v12, &v12, &v13, NULL);
	NEG_CHECK(v12, &v13, &v12, NULL);

	NEG_CHECK(v1, &v1, &v2, &v3, &v4, &v5, &v6, NULL);
	NEG_CHECK(v1, &v2, &v1, &v3, &v4, &v5, &v6, NULL);
	NEG_CHECK(v1, &v2, &v3, &v1, &v4, &v5, &v6, NULL);
	NEG_CHECK(v1, &v2, &v3, &v4, &v1, &v5, &v6, NULL);
	NEG_CHECK(v1, &v2, &v3, &v4, &v5, &v1, &v6, NULL);
	NEG_CHECK(v1, &v2, &v3, &v4, &v5, &v6, &v1, NULL);

	NEG_CHECK(v1, &v6, &v5, &v4, &v3, &v2, &v1, NULL);
	NEG_CHECK(v1, &v6, &v5, &v4, &v3, &v1, &v2, NULL);
	NEG_CHECK(v1, &v6, &v5, &v4, &v1, &v3, &v2, NULL);
	NEG_CHECK(v1, &v6, &v5, &v1, &v4, &v3, &v2, NULL);
	NEG_CHECK(v1, &v6, &v1, &v5, &v4, &v3, &v2, NULL);
	NEG_CHECK(v1, &v1, &v6, &v5, &v4, &v3, &v2, NULL);

	NEG_CHECK(v2, &v2, &v3, &v4, &v5, &v6, NULL);
	NEG_CHECK(v2, &v3, &v2, &v4, &v5, &v6, NULL);
	NEG_CHECK(v2, &v3, &v4, &v2, &v5, &v6, NULL);
	NEG_CHECK(v2, &v3, &v4, &v5, &v2, &v6, NULL);
	NEG_CHECK(v2, &v3, &v4, &v5, &v6, &v2, NULL);

	NEG_CHECK(v2, &v6, &v5, &v4, &v3, &v2, NULL);
	NEG_CHECK(v2, &v6, &v5, &v4, &v2, &v3, NULL);
	NEG_CHECK(v2, &v6, &v5, &v2, &v4, &v3, NULL);
	NEG_CHECK(v2, &v6, &v2, &v5, &v4, &v3, NULL);
	NEG_CHECK(v2, &v2, &v6, &v5, &v4, &v3, NULL);

	NEG_CHECK(v2, &v6, &v9, &v11, &v12, &v4, &v8, &v2, &v3, &v10, &v7, &v5, &v13, NULL);
	NEG_CHECK(v2, &v12, &v2, &v11, &v13, &v7, &v4, &v9, &v10, &v6, &v3, &v8, &v5, NULL);
	NEG_CHECK(v2, &v5, &v13, &v6, &v12, &v8, &v10, &v3, &v9, &v7, &v2, &v11, &v4, NULL);
	NEG_CHECK(v2, &v4, &v13, &v10, &v11, &v5, &v12, &v9, &v3, &v7, &v6, &v8, &v2, NULL);
	NEG_CHECK(v2, &v5, &v7, &v6, &v3, &v2, &v11, &v12, &v8, &v4, &v9, &v13, &v10, NULL);
	NEG_CHECK(v2, &v3, &v8, &v7, &v10, &v11, &v13, &v12, &v5, &v4, &v2, &v6, &v9, NULL);
	NEG_CHECK(v2, &v11, &v2, &v8, &v3, &v5, &v12, &v4, &v13, &v10, &v7, &v6, &v9, NULL);
	NEG_CHECK(v2, &v8, &v6, &v2, &v10, &v9, &v13, &v12, &v4, &v7, &v11, &v5, &v3, NULL);
	NEG_CHECK(v2, &v4, &v8, &v7, &v12, &v13, &v6, &v11, &v2, &v3, &v10, &v9, &v5, NULL);
	NEG_CHECK(v2, &v13, &v11, &v4, &v8, &v10, &v12, &v5, &v3, &v2, &v9, &v7, &v6, NULL);
	NEG_CHECK(v2, &v13, &v3, &v12, &v8, &v10, &v11, &v7, &v2, &v4, &v9, &v6, &v5, NULL);
	NEG_CHECK(v2, &v9, &v8, &v13, &v7, &v5, &v6, &v11, &v12, &v4, &v3, &v2, &v10, NULL);
	NEG_CHECK(v2, &v9, &v8, &v10, &v6, &v3, &v12, &v2, &v5, &v11, &v4, &v7, &v13, NULL);
	NEG_CHECK(v2, &v5, &v4, &v12, &v13, &v8, &v7, &v9, &v6, &v10, &v3, &v2, &v11, NULL);
	NEG_CHECK(v2, &v5, &v4, &v11, &v9, &v8, &v7, &v10, &v6, &v2, &v3, &v13, &v12, NULL);
	NEG_CHECK(v2, &v12, &v13, &v10, &v7, &v6, &v5, &v2, &v11, &v4, &v3, &v8, &v9, NULL);
	NEG_CHECK(v2, &v2, &v8, &v7, &v13, &v5, &v9, &v10, &v6, &v3, &v11, &v12, &v4, NULL);
	NEG_CHECK(v2, &v3, &v7, &v13, &v9, &v6, &v8, &v5, &v12, &v4, &v11, &v2, &v10, NULL);
	NEG_CHECK(v2, &v12, &v3, &v6, &v5, &v2, &v9, &v4, &v11, &v8, &v10, &v13, &v7, NULL);
	NEG_CHECK(v2, &v13, &v7, &v4, &v3, &v12, &v2, &v9, &v5, &v10, &v11, &v6, &v8, NULL);
	NEG_CHECK(v2, &v7, &v3, &v8, &v2, &v4, &v13, &v5, &v6, &v10, &v9, &v11, &v12, NULL);
	NEG_CHECK(v2, &v2, &v3, &v13, &v8, &v12, &v5, &v11, &v9, &v10, &v4, &v7, &v6, NULL);
	NEG_CHECK(v2, &v10, &v6, &v7, &v5, &v11, &v9, &v3, &v13, &v4, &v2, &v8, &v12, NULL);
	NEG_CHECK(v2, &v6, &v9, &v12, &v7, &v2, &v10, &v4, &v13, &v11, &v3, &v5, &v8, NULL);
	NEG_CHECK(v2, &v5, &v9, &v6, &v4, &v8, &v7, &v11, &v13, &v3, &v2, &v12, &v10, NULL);
	NEG_CHECK(v2, &v10, &v11, &v2, &v9, &v12, &v7, &v5, &v3, &v8, &v13, &v6, &v4, NULL);
	NEG_CHECK(v2, &v3, &v10, &v2, &v4, &v8, &v9, &v11, &v7, &v5, &v13, &v6, &v12, NULL);
	NEG_CHECK(v2, &v8, &v10, &v11, &v6, &v5, &v2, &v9, &v4, &v3, &v13, &v7, &v12, NULL);
	NEG_CHECK(v2, &v4, &v12, &v11, &v7, &v3, &v13, &v10, &v2, &v5, &v9, &v6, &v8, NULL);
	NEG_CHECK(v2, &v7, &v13, &v12, &v3, &v4, &v8, &v11, &v9, &v10, &v6, &v2, &v5, NULL);
	NEG_CHECK(v2, &v5, &v4, &v2, &v8, &v7, &v13, &v10, &v11, &v3, &v9, &v6, &v12, NULL);
	NEG_CHECK(v2, &v7, &v8, &v10, &v2, &v4, &v11, &v9, &v12, &v6, &v13, &v5, &v3, NULL);
	NEG_CHECK(v2, &v3, &v7, &v2, &v13, &v5, &v10, &v12, &v6, &v8, &v11, &v9, &v4, NULL);
	NEG_CHECK(v2, &v12, &v13, &v6, &v9, &v4, &v11, &v8, &v3, &v2, &v7, &v10, &v5, NULL);
	NEG_CHECK(v2, &v2, &v9, &v10, &v13, &v3, &v5, &v8, &v7, &v6, &v11, &v4, &v12, NULL);
	NEG_CHECK(v2, &v7, &v5, &v10, &v11, &v3, &v12, &v4, &v9, &v6, &v13, &v2, &v8, NULL);
	NEG_CHECK(v2, &v3, &v4, &v8, &v2, &v13, &v11, &v7, &v10, &v5, &v6, &v12, &v9, NULL);
	NEG_CHECK(v2, &v7, &v2, &v13, &v5, &v10, &v3, &v9, &v6, &v4, &v11, &v8, &v12, NULL);
	NEG_CHECK(v2, &v6, &v5, &v3, &v11, &v8, &v9, &v12, &v7, &v13, &v4, &v10, &v2, NULL);
	NEG_CHECK(v2, &v13, &v6, &v5, &v4, &v3, &v8, &v2, &v7, &v9, &v10, &v11, &v12, NULL);
	NEG_CHECK(v2, &v13, &v12, &v4, &v3, &v11, &v6, &v7, &v10, &v2, &v5, &v9, &v8, NULL);
	NEG_CHECK(v2, &v13, &v6, &v7, &v2, &v8, &v4, &v5, &v12, &v11, &v3, &v10, &v9, NULL);
	NEG_CHECK(v2, &v13, &v5, &v12, &v11, &v10, &v9, &v2, &v6, &v4, &v8, &v3, &v7, NULL);
	NEG_CHECK(v2, &v8, &v7, &v6, &v13, &v9, &v3, &v11, &v10, &v4, &v2, &v12, &v5, NULL);
	NEG_CHECK(v2, &v8, &v9, &v3, &v7, &v11, &v2, &v13, &v4, &v6, &v12, &v10, &v5, NULL);
	NEG_CHECK(v2, &v4, &v5, &v13, &v2, &v7, &v8, &v9, &v10, &v11, &v3, &v6, &v12, NULL);
	NEG_CHECK(v2, &v7, &v4, &v11, &v9, &v6, &v12, &v3, &v5, &v10, &v8, &v2, &v13, NULL);
	NEG_CHECK(v2, &v8, &v9, &v6, &v2, &v11, &v5, &v13, &v3, &v7, &v10, &v12, &v4, NULL);
